...
def generate_sentence(row):
    ...
    formats = [
        ...
        f"{size} {name} ({cusip}) {action_ed} at {price}",
        f"{size} {name} ({cusip}) - {price} {action} / {other_price} {other_action}",
        f"{name} ({cusip}) {action} at {price}",
        f"{cusip} {name} {action_ed} @ {price}",
        f"{size} {name} ({cusip}) - {action_ed} at {price} / {other_action_ed} at {other_price}"
    ]
